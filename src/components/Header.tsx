  ...
  return (
    ...
    <div className="header-wrapper  w-full">
        <div className="header flex justify-between w-full  max-w-[90%] lg:max-w-[980px] m-auto p-2">
            ...
            <div className="h-add-banner w-[200px] md:w-[500px] lg:w-[570px] h-[55px] md:h-[100px] bg-[#6a7f7b] text-white text-[16px] float-right">Contact us for your Advertisement</div>
        </div>
